/*
https://stepik.org/lesson/14513/step/9?auth=login&unit=4147
...
// Пихаем все в 1 файл, т.к. на сайте так
...
//--- хоть и сыпет ошибки, но работает правильно в проверке задачи на сайте
public Label checkLabels(TextAnalyzer[] textAnalyzers, String text){
    for(TextAnalyzer analizer : textAnalyzers){
